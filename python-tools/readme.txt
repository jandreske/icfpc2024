...
python3 decode.py "'%4}).$%8"
'%4}).$%8: get index

python3 encode.py "get index"
get index: '%4}).$%8

For submit-string, have the api key in a file called api-token.txt, single line key only (without "bearer").

python3 submit_string.py "get index"
